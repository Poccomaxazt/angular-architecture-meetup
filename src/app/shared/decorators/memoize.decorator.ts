/**
 * This decorator can cash the calculation value of functions
 *
...
export function Memoize(hashFunction?: (...args: any[]) => any) {
  return (target: Object, propertyKey: string, descriptor: TypedPropertyDescriptor<any>) => {
    if (descriptor.value !== null || descriptor.value !== void 0) {
      descriptor.value = getNewFunction(descriptor.value, hashFunction);
    } else if (descriptor.get !== null || descriptor.get !== void 0) {
